...
export interface WorkerPreloadHistoryMessage {
  type: "PRELOAD_HISTORY";
  symbols: string[];
  months?: number;
}

export interface WorkerSubscribeQuoteDetailMessage {
...
export type WorkerInboundMessage =
  ...
  | WorkerPreloadHistoryMessage
  | WorkerSubscribeQuoteDetailMessage;
...
export interface WorkerOrderBookMessage {
...
export interface WorkerTradeTapeMessage {
...
export type WorkerOutboundMessage =
  ...
  | WorkerOrderBookMessage
  | WorkerTradeTapeMessage;
